...
function showByType()
{
  ...
  //Le indicamos que cree un elemento div en nuestro HTML que contendrá toda la info
  let cards = document.createElement("div");
  //Aquí le diremos que tome la clase "cards" de css <div id="cards" class="cards"></div>
  cards.className =  "cards";
  //Le entregaremos un id
  cards.id = "cards";
...
function showByEgg()
{
  ...
  {
    let sortedPokemons = window.sortByAlphabet(pokemonList);
    document.getElementById("root").innerHTML="";
    ...
    //para asignarle su contenido
    //En pokemon.js "name"=""
    pokemonName.textContent = sortedPokemons[i].name;
    ...
    pokemonPhoto.src = sortedPokemons[i].img;
  
    let pokemonNumber = document.createElement("h3");
    //En pokemon.js "num"=""  
    pokemonNumber.textContent = sortedPokemons[i].num;
    ...
    //dos tipos entones que cree dos label.
    let pokemonType1 = document.createElement("h1");
    pokemonType1.textContent = sortedPokemons[i].type[0];
    let pokemonType2 = document.createElement("h1");
    pokemonType2.textContent = sortedPokemons[i].type[1];
