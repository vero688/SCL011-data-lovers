...
for(let i=0; i<pokemons.length;i++){
  ...
  model.textContent = pokemons[i].type[0];
...
/*
  ...
  function sortOrden(){
    let ordenList = ordenList.options[ordensType.selectedIndex].value;
    let ordenResul = window.ordenList(pokemons, ordenselected);
    document.getElementById("root").innerHTML="";
